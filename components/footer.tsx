        ...
        <div className="py-28 grid grid-rows-2 lg:grid-flow-col items-center">
          ...
          <div className="grid gap-y-4 lg:grid-flow-col lg:gap-x-4 justify-center lg:pl-4">
            <a className='bg-purple-600 py-1 px-8  lg:px-3 text-white border border-black group hover:bg-white font-bold' rel='me' href={"https://fosstodon.org/@shubhan"}>
              ...
              <span className="group-hover:text-black">Toot @shubhan on Mastodon</span></a>
            <a
              href={`${EXAMPLE_PATH}`}
              className=" font-bold hover:underline text-white py-2 px-10  lg:px-3  border border-black group hover:bg-white bg-gray-800 lg:mb-0"
            >
            ...
            <a
              ...
              className="bg-twitter group twitter-mention-button hover:bg-white border border-black text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mb-6 lg:mb-0"
            >
