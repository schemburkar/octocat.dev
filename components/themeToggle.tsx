...
const onThemeChange = () => {
    ...
    globalThis.updateTheme && globalThis.updateTheme();
}
...
const onMediaUpdate = ({ media, matches }) => {
...
const ThemeToggle = () => {
    ...
    useEffect(() => {
        globalThis.matchMedia(`(prefers-color-scheme: ${darkTheme})`).addEventListener('change', onMediaUpdate)
        return () => globalThis.matchMedia(`(prefers-color-scheme: ${darkTheme})`).removeEventListener("change", onMediaUpdate);
    }, []);
    return (
